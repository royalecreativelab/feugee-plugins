...
|---|---|---|---|
| **Knowledge Nuke** | `v3.3.3` | 6 files | installer script |
| **SideQuest** | `v1.6.3` | 8 files | installer script |
| **Feugelign** | `v1.4.3` | 8 files | installer script |
| **Feugee Motion** | `v1.2.3` | 8 files | installer script |
<!-- /TABLE -->
