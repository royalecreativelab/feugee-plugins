...
|---|---|---|---|
| **Knowledge Nuke** | `v3.3.2` | 6 files | installer script |
| **SideQuest** | `v1.6.2` | 8 files | installer script |
| **Feugelign** | `v1.4.2` | 8 files | installer script |
| **Feugee Motion** | `v1.2.2` | 8 files | installer script |
<!-- /TABLE -->
