...
|---|---|---|---|
| **Knowledge Nuke** | `v3.3.0` | 6 files | installer script |
| **SideQuest** | `v1.6.0` | 8 files | installer script |
| **Feugelign** | `v1.4.0` | 8 files | installer script |
| **Feugee Motion** | `v1.2.0` | 8 files | installer script |
<!-- /TABLE -->
