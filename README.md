...
|---|---|---|---|
| **Knowledge Nuke** | `v3.3.1` | 6 files | installer script |
| **SideQuest** | `v1.6.1` | 8 files | installer script |
| **Feugelign** | `v1.4.1` | 8 files | installer script |
| **Feugee Motion** | `v1.2.1` | 8 files | installer script |
<!-- /TABLE -->
